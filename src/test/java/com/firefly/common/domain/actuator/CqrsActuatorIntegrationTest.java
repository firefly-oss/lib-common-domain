package com.firefly.common.domain.actuator;

import com.firefly.common.domain.actuator.endpoint.CqrsMetricsEndpoint;
import com.firefly.common.domain.actuator.health.CqrsHealthIndicator;
...
import com.firefly.common.domain.cqrs.query.GetAccountBalanceQuery;
...
class CqrsActuatorIntegrationTest {
    ...
    @Import({
        ...
        com.firefly.common.domain.cqrs.command.CreateAccountHandler.class,
        com.firefly.common.domain.cqrs.query.GetAccountBalanceHandler.class
    })
