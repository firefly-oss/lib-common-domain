 ...
 */
package com.firefly.common.domain.authorization.examples;
                ...
                .flatMap(basicResult -> {
                    ...
                    return Mono.fromCallable(() -> {
                        if (!checkAccountAccess(accountId, userId, tenantId, context)) {
                            com.firefly.common.domain.authorization.AuthorizationError error =
                                com.firefly.common.domain.authorization.AuthorizationError.builder()
                                    .resource("access")
