...
import com.firefly.common.domain.events.inbound.EventListenerDispatcher;
import com.firefly.common.domain.events.inbound.SqsDomainEventsSubscriber;
import com.firefly.common.domain.events.outbound.*;
...
public class DomainEventsAutoConfiguration {
    ...
    public SmartLifecycle domainEventsKafkaSubscriber(ApplicationContext ctx,
        ...
        if (adapter == DomainEventsProperties.Adapter.KAFKA || 
            ...
            return new com.firefly.common.domain.events.inbound.KafkaDomainEventsSubscriber(ctx, props, events);
        }
    ...
    public SmartLifecycle domainEventsRabbitSubscriber(ApplicationContext ctx,
        ...
        if (adapter == DomainEventsProperties.Adapter.RABBIT || 
            ...
            return new com.firefly.common.domain.events.inbound.RabbitMqDomainEventsSubscriber(ctx, props, events);
        }
        return noopLifecycle();
    }
    ...
    public SmartLifecycle domainEventsKinesisSubscriber(ApplicationContext ctx,
        ...
        if (adapter == DomainEventsProperties.Adapter.KINESIS || 
            ...
            return new com.firefly.common.domain.events.inbound.KinesisDomainEventsSubscriber(ctx, props, events);
        }
        return noopLifecycle();
    }
